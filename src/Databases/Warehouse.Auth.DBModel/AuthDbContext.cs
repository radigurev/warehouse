...
namespace Warehouse.Auth.DBModel;

/// <summary>
/// EF Core database context for the authentication and authorization domain.
/// </summary>
public sealed class AuthDbContext : DbContext
{
    ...
    /// <summary>
    /// Configures composite keys and default values via Fluent API.
    /// </summary>

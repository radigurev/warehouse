...
/// <summary>
/// Request payload for searching and filtering purchase events with pagination.
/// </summary>
public sealed record SearchPurchaseEventsRequest
{
    /// <summary>
    /// Gets the event type filter. Optional.
    /// </summary>
    public string? EventType { get; init; }

    /// <summary>
    /// Gets the entity type filter. Optional.
    /// </summary>
    public string? EntityType { get; init; }

    /// <summary>
    /// Gets the entity ID filter. Optional.
    /// </summary>

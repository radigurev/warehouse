...
/// <summary>
/// Validates the update supplier address request payload per SDD-PURCH-001 section 3.3
/// with optional Nomenclature country code validation per CHG-ENH-001.
/// </summary>
public sealed class UpdateSupplierAddressRequestValidator : AbstractValidator<UpdateSupplierAddressRequest>
{
    private static readonly string[] AllowedAddressTypes = ["Billing", "Shipping", "Both"];

    /// <summary>
    /// Initializes validation rules for supplier address update.
    /// </summary>
    public UpdateSupplierAddressRequestValidator(

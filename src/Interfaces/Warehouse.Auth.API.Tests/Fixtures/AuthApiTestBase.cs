...
public abstract class AuthApiTestBase
{
    ...
    public virtual async Task SetUpAsync()
    {
        ...
        WarehouseDbContext context = scope.ServiceProvider.GetRequiredService<WarehouseDbContext>();
    ...
    /// </summary>
    protected async Task WithDbContextAsync(Func<WarehouseDbContext, Task> action)
    {
        using IServiceScope scope = _factory.Services.CreateScope();
        WarehouseDbContext context = scope.ServiceProvider.GetRequiredService<WarehouseDbContext>();
    ...
    /// </summary>
    protected async Task<T> ReadDbContextAsync<T>(Func<WarehouseDbContext, Task<T>> action)
    {
        using IServiceScope scope = _factory.Services.CreateScope();
        WarehouseDbContext context = scope.ServiceProvider.GetRequiredService<WarehouseDbContext>();

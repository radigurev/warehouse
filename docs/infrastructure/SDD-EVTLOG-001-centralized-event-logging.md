...
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Program.cs` (new — DI root, MassTransit registration, health checks)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Controllers/EventsController.cs` (new — read-only query endpoints)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Services/EventQueryService.cs` (new — search, get, correlation)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Services/Interfaces/IEventQueryService.cs` (new — service interface)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Consumers/AuthAuditLoggedEventConsumer.cs` (new)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Consumers/PurchaseEventOccurredEventConsumer.cs` (new)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Consumers/FulfillmentEventOccurredEventConsumer.cs` (new)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Consumers/InventoryEventOccurredEventConsumer.cs` (new)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Consumers/CustomerEventOccurredEventConsumer.cs` (new)
- `src/Interfaces/EventLog/Warehouse.EventLog.API/Warehouse.EventLog.API.csproj` (new)
- `src/Interfaces/EventLog/Warehouse.EventLog.API.Tests/` (new — NUnit test project)
